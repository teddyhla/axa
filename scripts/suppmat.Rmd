...
## 6. Circuit Change data
- first time circuit change happened is subsetted.
- checked that circuit change happen between the ecmo start and ecmo end time
- no circuit change 
...
Membership of anti-Xa group decreases by 0.95 the odds of having a larger TTR. 
Each additional day on ECMO increases the odds of having a larger TTR by 1.01.
Receipt of renal replacement therapy decreases the odds of having a large TTR by 0.6.
...
membership in anti Xa decreases variability by 86%. 
...
interaction was checked ttrg:group
AIC 
lrtest
